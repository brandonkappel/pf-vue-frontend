<template>
  <div class="flex flex-col h-screen bg-surface-50 dark:bg-surface-950">
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside
        class="hidden lg:flex flex-col w-56 shrink-0 border-r border-surface-200 dark:border-surface-800 bg-surface-0 dark:bg-surface-900">
    ...
    <nav
      class="fixed bottom-0 left-0 right-0 lg:hidden flex items-stretch border-t border-surface-200 dark:border-surface-800 bg-surface-0 dark:bg-surface-900 z-40">
      <router-link v-for="item in navItems" :key="item.to" :to="item.to"
